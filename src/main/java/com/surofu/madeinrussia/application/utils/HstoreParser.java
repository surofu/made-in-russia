...
public class HstoreParser {
    ...
    public static String toString(HstoreTranslationDto translation) {
        ...
        String res = String.format("\"en\"=>\"%s\", \"ru\"=>\"%s\", \"zh\"=>\"%s\"",
                translation.textEn().replace("\"", "\\\""),
                translation.textRu().replace("\"", "\\\""),
                translation.textZh().replace("\"", "\\\"")
        );
    ...
    public static HstoreTranslationDto fromString(String str) {
        String en = str.split("en\"=>\"")[1].split("\", \"ru\"")[0];
        String ru = str.split("ru\"=>\"")[1].split("\", \"zh\"")[0];
