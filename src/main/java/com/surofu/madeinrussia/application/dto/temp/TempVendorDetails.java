...
public final class TempVendorDetails implements Serializable {
    ...
    public TempVendorDetails() {
        ...
        mainDescription = List.of(
                ...
                """
                        Синтетические и минеральные смазки для экстремальных нагрузок \s
                        Линейка включает: \s
                        - Термостойкие составы для сталелитейных цехов (до +600°C); \s
                        - Биоразлагаемые масла для лесной техники; \s
                        - Пластичные смазки с дисульфидом молибдена для горнодобывающего оборудования. \s
