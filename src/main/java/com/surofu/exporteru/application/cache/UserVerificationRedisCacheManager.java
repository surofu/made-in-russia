...
public final class UserVerificationRedisCacheManager {
    ...
    public User getUser(UserEmail userEmail) throws OutOfAttemptsException, CacheEntityNotFoundException {
        UserWithAttempts userWithAttempts = userHashOperations.get(VERIFICATION_USER_CACHE_NAME, userEmail.toString());
    ...
    public String getVerificationCode(UserEmail userEmail) throws OutOfAttemptsException, CacheEntityNotFoundException {
        VerificationCodeWithAttempts verificationCodeWithAttempts = codeHashOperations.get(VERIFICATION_CODE_CACHE_NAME, userEmail.toString());
        ...
        try {
            ...
            codeHashOperations.put(VERIFICATION_CODE_CACHE_NAME, userEmail.toString(), verificationCodeWithAttempts);
    ...
    public void setVerificationCode(UserEmail userEmail, String verificationCode) {
        codeHashOperations.put(VERIFICATION_CODE_CACHE_NAME, userEmail.toString(), new VerificationCodeWithAttempts(verificationCode));
