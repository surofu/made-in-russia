  ...
  public void accept(Product product, UpdateProduct operation) {
    try {
      ...
      for (int i = 0; i < newCharacteristics.size(); i++) {
        ...
        characteristic.setName(new ProductCharacteristicName(characteristic.getName().getValue(),
            translatedTexts.get(i)));
        characteristic.setValue(new ProductCharacteristicValue(characteristic.getValue().getValue(),
            translatedTexts.get(i + newCharacteristics.size())));
      }
