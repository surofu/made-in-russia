...
import com.surofu.exporteru.application.command.faq.CreateFaqCommand;
import com.surofu.exporteru.application.command.faq.UpdateFaqCommand;
...
public class FaqRestController {
  ...
  private final GetFaqWithTranslationsById.Result.Processor<ResponseEntity<?>>
      getFaqWithTranslationsByIdProcessor;
  ...
  public ResponseEntity<?> getFaqById(
    ...
    if (hasTranslations) {
      ...
      return service.getFaqWithTranslationsById(operation)
          .process(getFaqWithTranslationsByIdProcessor);
    }
