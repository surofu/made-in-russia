...
public class AdvertisementRestController {
    ...
    public ResponseEntity<?> getAll(
        ...
        if (hasTranslations) {
            GetAllAdvertisementsWithTranslations operation = GetAllAdvertisementsWithTranslations.of(locale, text, sort, direction);
            return service.getAllAdvertisementsWithTranslations(operation).process(getAllAdvertisementsWithTranslationsProcessor);
        }

        GetAllAdvertisements operation = GetAllAdvertisements.of(locale, text, sort, direction);
