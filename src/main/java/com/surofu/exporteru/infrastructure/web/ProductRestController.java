...
public class ProductRestController {
    ...
    public ResponseEntity<?> getProductById(
        ...
        if (hasTranslations) {
            GetProductWithTranslationsById operation = GetProductWithTranslationsById.of(productId, locale, securityUser);
    ...
    public ResponseEntity<?> updateProductById(
        ...
        UpdateProduct operation = UpdateProduct.of(
                ...
                Objects.requireNonNullElse(updateProductCommand.oldAboutVendorMedia(), Collections.emptyList()),
    ...
    public ResponseEntity<?> createOrder(
        ...
        CreateOrder operation = CreateOrder.of(id, command.firstName(), command.email().toLowerCase(), command.phoneNumber(), command.quantity());
