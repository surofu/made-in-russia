...
import com.surofu.exporteru.application.components.telegrambot.*;
...
public class WebConfig {
    ...
    public TelegramLongPollingBot telegramLongPollingBot(
            @Qualifier("telegramBot1Config") TelegramBotConfig config,
    ...
    @Bean
    public TelegramLongPollingBot telegramLongPollingBot2(
            @Qualifier("telegramBot2Config") TelegramBotConfig config,
            LocalizationManager localizationManager,
            @Lazy TelegramBotRegisterHandler telegramBotRegisterHandler,
            @Lazy TelegramBotLoginHandler telegramBotLoginHandler,
            @Lazy TelegramBotLinkAccountHandler telegramBotLinkAccountHandler,
    ...
    public TelegramBot telegramBot(@Qualifier("telegramLongPollingBot") TelegramLongPollingBot bot) {
        return (TelegramBot) bot;
    }

    @Bean(name = "telegramBot2")
    public TelegramBot telegramBot2(@Qualifier("telegramLongPollingBot2") TelegramLongPollingBot bot) {
        return (TelegramBot) bot;
    }
}
