...
public class YandexTranslationRepository implements TranslationRepository {
  ...
  @Override
  public HstoreTranslationDto expand(HstoreTranslationDto dto)
  ...
  public HstoreTranslationDto expand(String text) throws EmptyTranslationException, IOException {
    ...
    return new HstoreTranslationDto(en.getTranslations()[0].getText(),
        ru.getTranslations()[0].getText(), zh.getTranslations()[0].getText());
  }

  @Override
  public List<HstoreTranslationDto> expand(String... texts)
      throws EmptyTranslationException, IOException {
    if (texts.length == 0) {
  ...
  @Override
  public Map<String, List<HstoreTranslationDto>> expandStrings(Map<String, List<String>> map)
      throws IOException {
  ...
  public Map<String, HstoreTranslationDto> expand(Map<String, HstoreTranslationDto> map)
    ...
    try {
      CompletableFuture.allOf(
          translateAsync(LanguageCode.EN, translationMap.get(LanguageCode.RU, LanguageCode.EN),
              result),
          translateAsync(LanguageCode.EN, translationMap.get(LanguageCode.ZH, LanguageCode.EN),
              result),
          translateAsync(LanguageCode.RU, translationMap.get(LanguageCode.EN, LanguageCode.RU),
              result),
          translateAsync(LanguageCode.RU, translationMap.get(LanguageCode.ZH, LanguageCode.RU),
              result),
          translateAsync(LanguageCode.ZH, translationMap.get(LanguageCode.EN, LanguageCode.ZH),
              result),
          translateAsync(LanguageCode.ZH, translationMap.get(LanguageCode.RU, LanguageCode.ZH),
              result)
      ).join();
  ...
  private CompletableFuture<Void> translateAsync(LanguageCode language, Map<String, String> map,
                                                 Map<String, HstoreTranslationDto> result) {
  ...
  private HstoreTranslationDto updateTranslation(HstoreTranslationDto existing,
                                                 LanguageCode language, String text) {
