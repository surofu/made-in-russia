...
public class JpaProductDeliveryMethodDetailsRepository
    implements ProductDeliveryMethodDetailsRepository {

  private final SpringDataProductDeliveryMethodDetailsRepository repository;

  @Override
  public List<ProductDeliveryMethodDetailsView> getAllViewsByProductIdAndLang(Long productId,
                                                                              String lang) {
    return repository.findAllViewsByProductIdAndLang(productId, lang);
  }

  @Override
  public List<ProductDeliveryMethodDetailsWithTranslationsView> getAllViewsWithTranslationsByProductIdAndLang(
