...
public interface SpringDataProductRepository extends JpaRepository<Product, Long> {
  ...
  @NotNull
  Optional<Product> findAllById(@Param("id") @NotNull Long productId);
  ...
  List<SearchHintView> findHintViews(@Param("searchTerm") String searchTerm,
                                     @Param("vendorId") Long vendorId, @Param("lang") String lang);
  ...
  @Query(value = """
      ...
      """, nativeQuery = true)
  Optional<ProductView> findProductViewByIdAndLangAndStatuses(@Param("id") Long id,
                                                              @Param("lang") String lang,
                                                              @Param("approveStatuses")
  ...
  @Query(value = """
      ...
      """, nativeQuery = true)
  Optional<ProductView> findProductViewByArticleCodeAndLang(@Param("article") String article,
                                                            @Param("lang") String lang);
  ...
  @Query(value = """
      ...
      """, nativeQuery = true)
  List<SimilarProductView> findAllSimilarProductViewByIdAndLang(@Param("id") Long id,
                                                                @Param("lang") String lang);
  ...
  @Query(value = """
       select
          ...
          where p.id = :id
      """, nativeQuery = true)
  Optional<ProductWithTranslationsView> findProductWithTranslationsByIdAndLang(@Param("id") Long id,
                                                                               @Param("lang")
                                                                               String lang);
  ...
  boolean existsByIdInUserFavorites(@Param("userId") Long userId,
