                                        ...
                                        jsonb_build_object(
                                                ...
                                                'media', COALESCE(
                                                        (SELECT jsonb_agg(
                                                         ...
                                                         GROUP BY vm.id, vm.url, vm.media_type, vm.mime_type,
                                                                  vm.position, vm.creation_date,
                                                                  vm.last_modification_date
...
from products p
         ...
         left join vendor_details vd on u.vendor_details_id = vd.id
