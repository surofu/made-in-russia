    ...
    begin
        begin
            ...
            (
                ...
                constraint fk_vendor_countries_user_id foreign key (user_id) references users (id)
            );

            create index if not exists idx_vendor_countries_user_id on vendor_countries (user_id);
