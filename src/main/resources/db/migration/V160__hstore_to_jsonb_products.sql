...
alter table products
    ...
    alter column main_description_translations drop default,
    alter column further_description_translations drop default;

alter table products
    alter column title_translations type jsonb using hstore_to_jsonb(title_translations),
    alter column main_description_translations type jsonb using hstore_to_jsonb(main_description_translations),
    alter column further_description_translations type jsonb using hstore_to_jsonb(further_description_translations);
