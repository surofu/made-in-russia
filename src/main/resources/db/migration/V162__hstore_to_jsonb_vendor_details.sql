...
alter table vendor_details
    alter column description_translations drop default,
    alter column address_translations drop default;

alter table vendor_details
    alter column description_translations type jsonb using hstore_to_jsonb(description_translations),
    alter column address_translations type jsonb using hstore_to_jsonb(address_translations);
